...
- **Presentaciones**: Disponible en [`Control-de-carro-arduino-con-servidor-HTTP-y-publicación-MQTT / presetaciones.pdf`](Control-de-carro-arduino-con-servidor-HTTP-y-publicación-MQTT/presentaciones.pdf)
